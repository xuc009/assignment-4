	...
	myDiv.addEventListener("mousemove", function(){
		...
		if(count > 50 && count <= 100){
			...
			myDiv.addEventListener('mouseover', function(){
				...
				var smallerSize = currentSize - 10; 
				console.log("smaller size:", smallerSize)
				// save or overwrite item: 
				localStorage.setItem('myDiv', smallerSize); 
		
				// update site:
				myDiv.style.height= `${smallerSize}px`;
				myDiv.style.width= `${smallerSize}px`;
